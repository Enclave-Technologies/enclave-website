...
const QuoteGenerator = () => {
    ...
    return (
    <div className="w-full flex flex-col flex-wrap gap-4 items-center justify-center mx-auto mt-2">
        <p className="text-[16px] md:text-[20px] lg:text-[24px] text-[#717171] font-medium normal-case text-center w-full lg:max-w-3xl mx-auto">
        ...
        <div className="w-full md:w-auto p-2 rounded-full md:border-2 focus-within:border-[#e2806a]">
            ...
            <select
                ...
                className="capitalize md:outline-none rounded-full px-2 bg-transparent text-lg min-h-[48px] border-[1px] border-black md:border-none"
            >
        ...
        <div className="flex flex-row gap-2 items-center">
            ...
            <p className="pt-0 md:pt-2 text-[12px] md:text-[16px] lg:text-[18px] text-[#323232] font-normal text-center w-full lg:max-w-3xl mx-auto capitalize">
